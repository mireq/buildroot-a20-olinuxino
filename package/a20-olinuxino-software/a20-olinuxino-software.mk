...
$(if ($(BR2_PACKAGE_A20_OLINUXINO_SOFTWARE_MOD_RTC),y),
    $(TARGET_CONFIGURE_OPTS) $(TARGET_CC) $(TARGET_CFLAGS) ${A20_OLINUXINO_SOFTWARE__MOD_RTC__DIR}/*.c -o ${A20_OLINUXINO_SOFTWARE__MOD_RTC__DIR}/${A20_OLINUXINO_SOFTWARE__MOD_RTC__EXE})
endef
